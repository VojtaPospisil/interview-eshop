...
$(document).ready(function () {
  $('.basket').on('click', function () {
    ...
    $('#quantity').val(1);
    console.log('modal opened'); // $('#myInput').trigger('focus')
  });
  ...
  $('.spinner>.ns-btn>a, .spinner>.ns-btn-sml>a').on('click', function () {
    ...
    var btn = $(this),
        ...
        newVal = 0; // console.log($(this).closest('div').attr('class'));
      ...
      jQuery.ajax({
        ...
        success: function success(data) {
          if (data.success) {
            ...
            $('.totalRow').load(' .totalRow'); // $('.wrap').load(' .wrap');
            // console.log(data);
...
__webpack_require__(/*! /Applications/MAMP/htdocs/my_projects/interview_project/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/my_projects/interview_project/resources/sass/app.scss */"./resources/sass/app.scss");
